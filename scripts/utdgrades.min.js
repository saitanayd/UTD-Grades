...
function(){window.open("https://www.ratemyprofessors.com/search.jsp?query="+encodeURI(p+" UT Dallas"),"_blank")}).css("display","block");$("#btn_reddit").off("click").on("click",function(){window.open("https://www.reddit.com/r/utdallas/search/?q="+encodeURI(p)+"&restrict_sr=1","_blank")}).css("display","block");$("#btn_share").attr("data-content",function(){return window.location.origin+"/?id="+a}).css("display","block");Highcharts.chart("main-chart",{chart:{type:"column",backgroundColor:"#f8f9fa"},
